...
class PostItem extends Component {
  ...
  render() {
    const { post, auth, key, showActions } = this.props;
      
    return (
        <div className="posts col-md-12 mb-3" key={key}>
            <div className="card">
                <div className="card-body">
                    <div className="row">
                        <div className="col-md-2 sp-w50">
                            <img 
                                src={post.avatar}
                                alt={post.name}
                            ...
                            {showActions ? (
                                <span>
                                    ...
                                    {post.user === auth.user.id ? (
                                        <button onClick= {this.onDeleteClick.bind(this, post._id) } type="button" className="btn btn-secondary mr-1">Remove post</button>
                                    ) : null }
                                </span>
                            ) : null }
                            <br/>
